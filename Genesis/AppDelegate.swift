...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func gotoLoginScreen() {
        ...
        let routeVC = authStoryboard.instantiateViewController(withIdentifier: "LoginViewController") as! LoginViewController
        navigationController = UINavigationController.init(rootViewController: routeVC)
        navigationController.navigationBar.isHidden = true
        window = UIWindow.init(frame: CGRect(x: 0, y: 0, width: WINDOW_WIDTH, height: WINDOW_HEIGHT))
