...
public final class JBDatePickerWeekDaysView: UIStackView {
    ...
    private func setup() {
        ...
        for i in 0...6 {
            ...
            labelContainerView.backgroundColor = UIColor.init(red: (229/255.0), green: (229/255.0), blue: (229/255.0), alpha: 1.0)
            ...
            weekDayLabel.textColor = UIColor.darkGray
           // weekDayLabel.font = UIFont.init(name: "Hiragino Maru Gothic ProN-W4", size: 19.0)
    ...
    func updateLayout() {
        ...
        for (index, label) in weekdayLabels.enumerated() {
            fontToUse = UIFont.init(name: "Hiragino Maru Gothic ProN", size: 16.0)!
