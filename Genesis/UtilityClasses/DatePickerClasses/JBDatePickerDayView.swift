...
public final class JBDatePickerDayView: UIView {
    ...
    init(datePickerView: JBDatePickerView, monthView: JBDatePickerMonthView, weekView: JBDatePickerWeekView, index: Int, dayInfo: JBDay) {
        ...
        if isToday {
            self.textLabel.textColor = UIColor.purple
        }
    ...
    private func labelSetup() {
        ...
        textLabel.font = UIFont.init(name: "Hiragino Maru Gothic ProN", size: 10.0)!
    ...
    private func setupLabelFont() {
        ...
        fontToUse = UIFont.init(name: "Hiragino Maru Gothic ProN", size: 15.0)!
